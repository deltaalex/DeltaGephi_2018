 ...
 * calculates the median of all the values.
 * @author Eduardo Ramos <eduramiba@gmail.com>
 */
public class MedianNumber implements AttributeRowsMergeStrategy {
    ...
    public void execute() {
        result = StatisticsUtils.median(Lookup.getDefault().lookup(AttributeColumnsController.class).getRowsColumnNumbers(rows, column));
    }

    public String getName() {
        return NbBundle.getMessage(AverageNumber.class, "MedianNumber.name");
    }

    public String getDescription() {
        return NbBundle.getMessage(AverageNumber.class, "MedianNumber.description");
    }
