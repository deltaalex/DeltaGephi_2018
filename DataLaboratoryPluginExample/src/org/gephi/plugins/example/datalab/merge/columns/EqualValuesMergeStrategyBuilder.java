...
/**
 * Builder for EqualValuesMergeStrategy
 * @author Eduardo Ramos<eduramiba@gmail.com>
 */
@ServiceProvider(service=AttributeColumnsMergeStrategyBuilder.class)
public class EqualValuesMergeStrategyBuilder implements AttributeColumnsMergeStrategyBuilder{

    @Override
    public AttributeColumnsMergeStrategy getAttributeColumnsMergeStrategy() {
        return new EqualValuesMergeStrategy();
    }
