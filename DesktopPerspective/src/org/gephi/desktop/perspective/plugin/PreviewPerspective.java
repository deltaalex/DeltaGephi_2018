...
public class PreviewPerspective implements Perspective {
    ...
    @Override
    public Icon getIcon() {
        return ImageUtilities.loadImageIcon("org/gephi/desktop/perspective/plugin/resources/preview.png", false);
    }

    @Override
    public String getDisplayName() {
        return NbBundle.getMessage(PreviewPerspective.class, "PreviewPerspective.name");
    }
