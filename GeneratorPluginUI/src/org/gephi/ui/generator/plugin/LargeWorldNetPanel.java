 ...
 */
public class LargeWorldNetPanel extends javax.swing.JPanel {
     ...
     */
    public LargeWorldNetPanel() {
        initComponents();
    }

    public static ValidationPanel createValidationPanel(LargeWorldNetPanel innerPanel) {
        ValidationPanel validationPanel = new ValidationPanel();
        if (innerPanel == null) {
            innerPanel = new LargeWorldNetPanel();
        }
    ...
    private void initComponents() {
        ...
        nodeLabel.setText(org.openide.util.NbBundle.getMessage(LargeWorldNetPanel.class, "FacebookGraphPanel.nodeLabel.text_2")); // NOI18N

        nodesField.setText(org.openide.util.NbBundle.getMessage(LargeWorldNetPanel.class, "FacebookGraphPanel.cellField.text_1")); // NOI18N

        jSeparator1.setForeground(new java.awt.Color(0, 0, 204));

        animateCheckBox.setSelected(true);
        animateCheckBox.setText(org.openide.util.NbBundle.getMessage(LargeWorldNetPanel.class, "FacebookGraphPanel.animateCheckBox.text")); // NOI18N
        ...
        labelResolution.setText(org.openide.util.NbBundle.getMessage(LargeWorldNetPanel.class, "FacebookGraphPanel.labelResolution.text")); // NOI18N
        ...
        tAnimateNode.setText(org.openide.util.NbBundle.getMessage(LargeWorldNetPanel.class, "FacebookGraphPanel.tAnimateNode.text")); // NOI18N

        labelResolution1.setForeground(new java.awt.Color(102, 102, 102));
        labelResolution1.setLineWrap(true);
        labelResolution1.setText(org.openide.util.NbBundle.getMessage(LargeWorldNetPanel.class, "FacebookGraphPanel.labelResolution1.text")); // NOI18N
        ...
        tAnimateEdge.setText(org.openide.util.NbBundle.getMessage(LargeWorldNetPanel.class, "FacebookGraphPanel.tAnimateEdge.text")); // NOI18N

        labelResolution2.setForeground(new java.awt.Color(102, 102, 102));
        labelResolution2.setLineWrap(true);
        labelResolution2.setText(org.openide.util.NbBundle.getMessage(LargeWorldNetPanel.class, "FacebookGraphPanel.labelResolution2.text")); // NOI18N
        ...
        labelResolution3.setText(org.openide.util.NbBundle.getMessage(LargeWorldNetPanel.class, "FacebookGraphPanel.labelResolution3.text")); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(nodesField, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
