 ...
 */
package org.gephi.plugins.example.importer;
...
public class MatrixFileImporterBuilder implements FileImporterBuilder {

    public static final String IDENTIFER = "mtx";

    @Override
    public FileImporter buildImporter() {
        return new MatrixFileImporter();
    }
    ...
    public FileType[] getFileTypes() {
        FileType ft = new FileType(".mtx", "Matrix Market format");
