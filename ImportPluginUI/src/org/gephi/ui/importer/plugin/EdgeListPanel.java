...
public class EdgeListPanel extends javax.swing.JPanel {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(configurationCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 24, Short.MAX_VALUE)
    ...
    private static boolean isSqlite(EdgeListPanel panel) {
        if (panel.databaseManager.getEdgeListDatabases().size() > 0) {
            if (panel.databaseManager.getEdgeListDatabases().get(0).getSQLDriver().getPrefix().equals("sqlite")) {
                return true;
            }
            return false;
        } else if (panel.getSelectedSQLDriver().getPrefix().equals("sqlite")) {
            return true;
        }
        return false;
    }
