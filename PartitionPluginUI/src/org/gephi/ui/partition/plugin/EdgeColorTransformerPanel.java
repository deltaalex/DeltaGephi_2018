...
public class EdgeColorTransformerPanel extends javax.swing.JPanel {
    ...
    private void createPopup() {
        ...
        JMenuItem allBlackItem = new JMenuItem(NbBundle.getMessage(EdgeColorTransformerPanel.class, "EdgeColorTransformerPanel.action.allBlacks"));
    ...
    class ColorChooserRenderer extends JLabel implements TableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            Color c = edgeColorTransformer.getMap().get(value);
            setBackground(c);
            return this;
        }
    }
