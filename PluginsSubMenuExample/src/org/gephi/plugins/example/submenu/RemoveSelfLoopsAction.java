...
/**
 * Example of an action that manipulates the graph. The action is set up in the
 * "Plugins" menu in the menubar.
 * <p>
 * The annotations on the class defines the menu's name, position and class.
 * <p>
 * The action itself accesses the graph the removes self-loops, if any.
 * 
