...
public class DeltaComparisonUI implements StatisticsUI, StatisticsUICallbackProvider {
    ...
    public void setup(Statistics statistics) {
        ...
        if (panel != null) {
            ...
            panel.dissimilarityField.setText(String.valueOf(delta.getDissimilarity()));
            panel.toggleSimulation.setSelected(delta.getEnableSimulation());
        }
    }
    ...
    public void unsetup() {
        ...
        if (panel != null) {
            ...
            delta.setDissimilarity(Double.parseDouble(panel.dissimilarityField.getText()));
            delta.setEnableSimulation(panel.toggleSimulation.isSelected());
        }
        panel = null;
    }
