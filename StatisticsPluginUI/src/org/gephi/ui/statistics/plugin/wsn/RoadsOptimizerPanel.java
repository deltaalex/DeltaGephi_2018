 ...
 */
public class RoadsOptimizerPanel extends javax.swing.JPanel {
    ...
    public static ValidationPanel createValidationPanel(RoadsOptimizerPanel innerPanel) {
        ValidationPanel validationPanel = new ValidationPanel();
        if (innerPanel == null) {
            innerPanel = new RoadsOptimizerPanel();
        }
    ...
    private void initComponents() {
        ...
        header.setDescription(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.header.description_1")); // NOI18N
        header.setDescriptionForeground(new java.awt.Color(51, 102, 255));
        header.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/gephi/ui/statistics/plugin/wsn/wifi_network.png"))); // NOI18N
        header.setIconPosition(org.jdesktop.swingx.JXHeader.IconPosition.LEFT);
        header.setTitle(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.header.title_1")); // NOI18N
        ...
        resolutionField.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.resolutionField.text")); // NOI18N

        jLabel3.setForeground(new java.awt.Color(102, 102, 102));
        jLabel3.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.jLabel3.text")); // NOI18N

        growthBox.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.growthBox.text")); // NOI18N
        ...
        jLabel4.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.jLabel4.text")); // NOI18N

        radiusRatioField.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        radiusRatioField.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.radiusRatioField.text")); // NOI18N

        jLabel5.setForeground(new java.awt.Color(102, 102, 102));
        jLabel5.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.jLabel5.text")); // NOI18N

        animateCheckBox.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.animateCheckBox.text")); // NOI18N
        ...
        labelResolution.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.labelResolution.text")); // NOI18N
        ...
        tAnimateNode.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.tAnimateNode.text")); // NOI18N

        labelResolution1.setForeground(new java.awt.Color(102, 102, 102));
        labelResolution1.setLineWrap(true);
        labelResolution1.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.labelResolution1.text")); // NOI18N
        ...
        tAnimateEdge.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.tAnimateEdge.text")); // NOI18N

        labelResolution2.setForeground(new java.awt.Color(102, 102, 102));
        labelResolution2.setLineWrap(true);
        labelResolution2.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.labelResolution2.text")); // NOI18N
        ...
        labelResolution3.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.labelResolution3.text")); // NOI18N
        ...
        wifiRadiusField.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.wifiRadiusField.text")); // NOI18N
        wifiRadiusField.setToolTipText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.wifiRadiusField.toolTipText")); // NOI18N

        jLabel7.setForeground(new java.awt.Color(102, 102, 102));
        jLabel7.setText(org.openide.util.NbBundle.getMessage(RoadsOptimizerPanel.class, "RoadsOptimizerPanel.jLabel7.text")); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(resolutionField, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jLabel3))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(wifiRadiusField, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
